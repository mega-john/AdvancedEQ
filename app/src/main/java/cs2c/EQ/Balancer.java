...
public class Balancer extends Activity implements OnClickListener {
    ...
    private OnSeekBarChangeListener mOnSeekBarChangeListener = new OnSeekBarChangeListener() {
        public void onProgressChanged(SeekBar sb, int progress, boolean arg2) {
            ...
            Balancer.this.mAddValueTextView.setText(String.format("+%s", String.valueOf(Balancer.increaseValue)));
        }
        ...
        public boolean onTouch(View v, MotionEvent mEvent) {
            switch (mEvent.getAction()) {
                ...
                case 2:
                    ...
                    Log.d("lzc", "left=" + left + "  top=" + top + "  right=" + right + "  bottom=" + bottom);
    ...
    private void displayView() {
        ...
        this.mAddValueTextView.setText(String.format("+%s", String.valueOf(increaseValue)));
